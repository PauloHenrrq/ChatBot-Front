                    ...
                    <div className="relative flex h-16 items-center justify-between">
                        <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                            ...
                            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset">
                                ...
                                <Bars3Icon aria-hidden="true" className="block stroke-white size-6 group-data-open:hidden" />
                                <XMarkIcon aria-hidden="true" className="hidden stroke-white size-6 group-data-open:block" />
                            </DisclosureButton>
                        </div>
                                    ...
                                    {navigation.map((item) => (
                                        <a
                                            ...
                                            className={classNames(
                                                item.current ? 'bg-orange-600 text-white' : 'text-zinc-100 hover:bg-orange-600 hover:text-white',
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            <button
                                type="button"
                                className="relative rounded-full cursor-pointer bg-white p-1 text-gray-400 hover:text-orange-500 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden"
                            >
